...
TRAIN_DATASET_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "outputs", "similar_mini_train")
TEST_DATASET_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "outputs", "similar_mini_test")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="The save directory for the preprocessed train dataset.",
    )
    

    
    
    data_source = "omni_math_similar_questions"

    
    print(f'im loading traindataset from {TRAIN_DATASET_PATH}')
    train_dataset = datasets.load_from_disk(TRAIN_DATASET_PATH)
    print(f'im loading test dataset from {TEST_DATASET_PATH}')
